...
class Autocomplete {
  ...
  createItem(lookup, item) {
    ...
    return ce(`<button type="button" class="dropdown-item" data-label="${item.label}" data-value="${item.value}">${label}<br><span class="text-muted small">${item.tag}</span></button>`);
  }
